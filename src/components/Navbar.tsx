...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 backdrop-blur-2xl transition-colors bg-bodyColor/70 mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600 px-4">
      <div className="h-20 w-72 flex flex-row items-center justify-center space-x-2">
        <img
          src={logo}
          alt="logo"
          className="h-full w-20 object-cover rounded-full"
        />
        <span className="font-bold">R.F Elisé</span>
      </div>
      <div>
            ...
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Spécialisé en front-end moderne, je conçois des applications
                  web réactives et élégantes, alliant performance, animations et
                  ergonomie grâce à React.js, Vite et Tailwind.
                </p>
              </div>
